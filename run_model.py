...
# add filepath to current directory
...
command_list = [f"import os; os.chdir('$FILEPATH'); from data_modelling import results_gen; results_gen('{km}','{k}','{p}').modelTraining()" for km in kmer_list for k in k_list for p in predicting_list]
